...
return [
    ...
    'filled'               => 'Le champ :attribute ne doit pas être vide.',
    'gt'                   => [
    ...
    'min'                  => [
        'array'   => 'Le tableau :attribute doit contenir au minimum :min éléments.',
        'file'    => 'Le fichier :attribute doit peser au minimum :min kilo-octets.',
        'numeric' => 'La valeur de :attribute doit être supérieure ou égale à :min.',
        'string'  => 'Le texte :attribute doit contenir au minimum :min caractères.',
    ],
    ...
    'attributes' => [
        ...
        'picture'               => 'photo',
        'remove_picture'        => 'suppression de la photo',
        ...
        'group_ids.*'           => 'classe',
        'subject_id'            => 'matière',
        'subject_ids'           => 'matières',
        'subject_ids.*'         => 'matière',
        'lm_level'              => 'niveau LM',
        'teacher_ids'           => 'professeurs',
        'teacher_ids.*'         => 'professeur',
        ...
        'date'                  => 'date',
        'statuses'              => 'présences',
        'statuses.*.student_id' => 'élève',
        'statuses.*.type'       => 'statut',
        'statuses.*.motive'     => 'motif',
        ...
        'classroom'             => 'local',
        'delete_entry_id'       => 'entrée à supprimer',

        // Créneaux / slots
        'start_time'            => 'heure de début',
        'end_time'              => 'heure de fin',
        'slots'                 => 'créneaux',
        'slots.*.slot_id'       => 'créneau',
        'slots.*.start_time'    => 'heure de début',
        'slots.*.end_time'      => 'heure de fin',
