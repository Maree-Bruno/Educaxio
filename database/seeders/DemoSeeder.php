...
class DatabaseSeeder extends Seeder
{
    ...
    private const HOMEWORK_TITLES = [
        'Langue néerlandaise' => [
            'Woordenschat h. %d p. %d', 'Grammatica oefeningen %d–%d', 'Tekst lezen h. %d', 'Schrijfoefening p. %d'
        ],
        'Langue anglaise' => [
            'Vocabulary p. %d–%d', 'Grammar exercises %d to %d', 'Read and summarize ch. %d', 'Listening worksheet %d'
        ],
        'Langue allemande' => [
            'Wortschatz S. %d', 'Grammatik Übungen %d–%d', 'Text lesen Kap. %d', 'Schreibübung S. %d'
        ],
        'Langue française' => [
            'Rédaction p. %d', 'Analyse de texte p. %d', 'Conjugaison – fiche %d', 'Lecture ch. %d à %d'
        ],
        'Mathématiques' => ['Ex. p. %d n° %d à %d', 'Série algèbre p. %d', 'Problèmes p. %d', 'Fiche de révision %d'],
        'Sciences' => [
            'Résumé ch. %d', 'Fiche d\'observation p. %d', 'Questions p. %d–%d', 'Schéma à compléter ch. %d'
        ],
        'Physique' => [
            'Ex. p. %d n° %d à %d', 'Problèmes – ch. %d', 'Fiche de lois ch. %d', 'Exercices de conversion p. %d'
        ],
        'Chimie' => [
            'Équations à équilibrer p. %d', 'Exercices – ch. %d', 'Fiche nomenclature %d', 'Questions p. %d–%d'
        ],
        'Biologie' => ['Résumé ch. %d', 'Schéma à légender p. %d', 'Questions p. %d–%d', 'Compte-rendu TP %d'],
        'Histoire' => [
            'Résumé du cours – ch. %d', 'Analyse de document p. %d', 'Frise chronologique %d', 'Questions p. %d–%d'
        ],
    ...
    private function buildLessonData(
        ...
        Collection $teachers,
        int $maxGroupsTotal = PHP_INT_MAX
    ): Collection {
        $lessonData = collect();
    ...
    private function createSessionWithAttendance(
        Lesson $lesson,
        Carbon $date,
        Collection $students,
        string $subjectName
