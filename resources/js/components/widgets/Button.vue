...
const variantClasses = computed(
    () =>
        ({
            primary:'bg-blue text-white hover:opacity-85 focus-visible:ring-blue',
            secondary: 'bg-orange text-white hover:opacity-85 focus-visible:ring-orange',
            danger:'bg-pink text-white hover:opacity-85 focus-visible:ring-pink',
        })[props.variant],
);
