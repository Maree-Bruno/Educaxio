...
<template>
    ...
    >
        <button
            class="relative z-10 rounded-lg p-2 transition-colors hover:bg-hover-nav md:hidden"
        ...
        <p class="pointer-events-none absolute inset-x-0 text-center text-xl font-bold tracking-[-2px] text-text-base lg:text-3xl">
            {{ title }}
        </p>
